  ...
  return (
    <article className="workspace-card glass-panel">
      ...
      <style>{`
        ...
        .info-readout { padding: 1rem; background: rgba(99,102,241,0.05); border-left: 3px solid var(--color-primary); border-radius: 0 var(--radius-md) var(--radius-md) 0; color: var(--color-text-muted); font-size: 0.9rem; }
