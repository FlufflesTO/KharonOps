...
CREATE TABLE IF NOT EXISTS sites (
  ...
  client_uid TEXT NOT NULL REFERENCES clients (client_uid) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS technicians (
  technician_uid TEXT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS schedules (
  ...
  request_uid TEXT NOT NULL REFERENCES schedule_requests (request_uid) ON DELETE CASCADE,
  job_uid TEXT NOT NULL REFERENCES jobs (job_uid) ON DELETE CASCADE,
  calendar_event_id TEXT NOT NULL DEFAULT '',
  start_at TIMESTAMPTZ NOT NULL,
  end_at TIMESTAMPTZ NOT NULL,
  technician_uid TEXT NOT NULL REFERENCES technicians (technician_uid) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS sync_queue (
  ...
  job_uid TEXT NOT NULL REFERENCES jobs (job_uid) ON DELETE CASCADE,
  actor_uid TEXT NOT NULL REFERENCES users (user_uid) ON DELETE RESTRICT,
  payload_json JSONB NOT NULL DEFAULT '{}'::jsonb,
...
CREATE TABLE IF NOT EXISTS audit_events (
  ...
  action TEXT NOT NULL,
  payload_json JSONB NOT NULL DEFAULT '{}'::jsonb,
  actor_user_uid TEXT NOT NULL DEFAULT '',
  correlation_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS attachments (
  attachment_uid TEXT PRIMARY KEY,
  job_uid TEXT NOT NULL REFERENCES jobs (job_uid) ON DELETE CASCADE,
  document_uid TEXT REFERENCES job_documents (document_uid) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS site_contacts (
  site_contact_uid TEXT PRIMARY KEY,
  site_uid TEXT NOT NULL REFERENCES sites (site_uid) ON DELETE CASCADE,
  client_uid TEXT NOT NULL REFERENCES clients (client_uid) ON DELETE RESTRICT,
  name TEXT NOT NULL,
  email TEXT NOT NULL DEFAULT '',
  phone TEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS contracts (
  ...
  client_uid TEXT NOT NULL REFERENCES clients (client_uid) ON DELETE RESTRICT,
  site_uid TEXT REFERENCES sites (site_uid) ON DELETE SET NULL,
